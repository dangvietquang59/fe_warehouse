...
const Login = () => {
    ...
    return(
        <div className="h-screen flex items-center justify-center bg-gray-100">
            <div className="rounded-[10px] shadow-md w-[500px] h-[700px] p-[20px] bg-white flex flex-col gap-[20px]">
                ...
                <form className="flex flex-col gap-[20px]">
                    ...
                    <InputComponent name="abc"  label="Mật khẩu" placeholder="Nhập mật khẩu" control={control} required />
